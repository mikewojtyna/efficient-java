 ...
 */
package pro.buildmysoftware.efficientjava.review.latencies;

/**
 * This is what will run in the worker threads. It will do some arbitrary
 * work, and then log some
